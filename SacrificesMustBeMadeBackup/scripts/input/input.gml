...
// Player 4
	...
	kLeft			= keyboard_check(vk_numpad0)	|| (gamepad_axis_value(2, gp_axislh) < 0)	|| gamepad_button_check(2, gp_padl);
	kRight			= keyboard_check(vk_numpad1) 	|| (gamepad_axis_value(2, gp_axislh) > 0)	|| gamepad_button_check(2, gp_padr);
	kUp			    = keyboard_check(vk_numpad2) 	|| (gamepad_axis_value(2, gp_axislv) < 0)	|| gamepad_button_check(2, gp_padu);
	kDown			= keyboard_check(vk_numpad3) 	|| (gamepad_axis_value(2, gp_axislv) > 0)	|| gamepad_button_check(2, gp_padd);
